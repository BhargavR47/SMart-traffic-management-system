...
Original file is located at
    https://colab.research.google.com/drive/1wks6Lpj7ClB74TVHz4H6Qs56dDjC_II3
"""
...
class Main:
    ...
    background = pygame.image.load(r'C:\Users\bharg\python\images\intersection.png')
    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")
    redSignal = pygame.image.load(r'C:\Users\bharg\python\images\red.png')
    yellowSignal = pygame.image.load(r'C:\Users\bharg\python\images\yellow.png')
    greenSignal = pygame.image.load(r'C:\Users\bharg\python\images\green.png')
...
while vidcap.isOpened():
  ...
  #reference traffic line
  cv2.line(frame, (220,450), (1000,450), (0,0,255) , 2)
  cv2.line(frame, (220,440), (1000,440), (0,255,0) , 1)
  cv2.line(frame, (220,460), (1000,460), (0,255,0) , 1)
  ...
  for c in conts:
    ...
    if ymid >400 and ymid<460:
      vehicle += 1


  cv2.imshow("Forebackgroung mask",fgmask)
